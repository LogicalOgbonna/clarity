/*
  ...
  - Added the required column `dataPublished` to the `policy` table without a default value. This is not possible if the table is not empty.
...
CREATE TABLE "new_policy" (
    ...
    "dataPublished" DATETIME NOT NULL,

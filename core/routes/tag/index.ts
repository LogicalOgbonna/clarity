...
router.get('/', async (req, res) => {
  try {
    ...
    console.error(error);
    res.status(500).json({error: 'Internal server error', status: 'error', message: 'Tags fetching failed'});
  }
});
...
router.post('/', async (req, res) => {
  try {
    ...
    console.error(error);
    res.status(500).json({error: 'Internal server error', status: 'error', message: 'Tag creation failed'});
  }
});
...
router.get('/:id', async (req, res) => {
  try {
    ...
    console.error(error);
    res.status(500).json({error: 'Internal server error', status: 'error', message: 'Tag fetching failed'});
  }
});
...
router.put('/:id', async (req, res) => {
  try {
    ...
    console.error(error);
    res.status(500).json({error: 'Internal server error', status: 'error', message: 'Tag update failed'});
  }
});
...
router.delete('/:id', async (req, res) => {
  try {
    ...
    console.error(error);
    res.status(500).json({error: 'Internal server error', status: 'error', message: 'Tag deletion failed'});
  }
});

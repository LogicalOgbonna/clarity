...
class Scrapper {
  ...
  public static findElement = async (): Promise<{
    ...
    console.log('🚀 ~ Scrapper ~ findElement:', document.readyState);
    ...
    // if (termsServerLink && this.isValidUrl(termsServerLink)) {
    // Check if DOM is already loaded, if not wait for it
    // if (document.readyState === 'loading') {
    //   document.addEventListener('DOMContentLoaded', () => {
    //     console.log('DOMContentLoaded');
    console.log(document.querySelectorAll(`a[href='${privacyServerLink}']`));
    console.log(document.querySelectorAll(`a[href='${termsServerLink}']`));
    console.log(
      '🚀 ~ Scrapper ~ privacyServerLink:',
      `a[href="${privacyServerLink}"]`
    );
    console.log('🚀 ~ Scrapper ~ termsServerLink:', termsServerLink);
    //   });
    // } else {
    ...
    // if (
    //   (privacyServerLink && this.isValidUrl(privacyServerLink)) ||
    //   (termsServerLink && this.isValidUrl(termsServerLink))
    // ) {
    //   const set = new Map();
    //   Array.from(document.querySelectorAll('a[href]'))
    //     .filter((a) => {
    //       console.log('🚀 ~ Scrapper ~ a:', a);
    //       //   return (
